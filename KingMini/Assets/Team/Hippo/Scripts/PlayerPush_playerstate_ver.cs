...
public class PlayerPush_playerstate_ver : MonoBehaviour
{
    [Header("Direction")]
    public bool up;
    public bool down;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.tag == "Player")
        {
            ...
            if(collision.gameObject.GetComponent<PlayerState>().state == PlayerState.State.Nomal)
            {
            ...
            {
                rigid.AddForce(vec*power, ForceMode.VelocityChange);
            }
